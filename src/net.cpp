...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Eijecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"eijecointools.com", "124.182.34.230 "},
    {"eijecointool.com", "162.250.125.26"}
};

static const char *strTestNetDNSSeed[][2] = {
    {"eijecointools.com", "testnet-seed.eijecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Eijecoin is probably already running."), addrBind.ToString().c_str());
        else
